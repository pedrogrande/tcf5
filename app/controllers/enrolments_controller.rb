class EnrolmentsController < ApplicationController
  ...
  private
    ...
    def enrolment_params
      params.require(:enrolment).permit(:first_name, :last_name, :phone, :email, :address, :suburb, :state, :postcode, :country, :paid, :price, :guid, :stripe_id, :course_id, :intake_id, :payment_id, :special_id)
    end
end
